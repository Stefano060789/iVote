...
export const FEATURE_COPY = {
  ...
  emailBenefits: { label: "Email-sharing benefits", minPlan: "starter" },
  publicReviewLinks: { label: "Public review invitations", minPlan: "starter" },
